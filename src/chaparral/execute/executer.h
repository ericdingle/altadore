...
public:
  ...
  bool Execute(const Symbol* symbol, memory::scoped_refptr<Value>* result);
...
private:
  ...
  bool ExecuteSimpleSymbol(const Symbol* symbol, memory::scoped_refptr<Value>* result) const;
