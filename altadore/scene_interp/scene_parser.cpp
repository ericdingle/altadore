...
absl::StatusOr<std::unique_ptr<Node>> SceneParser::Parse() {
...
absl::StatusOr<std::unique_ptr<Node>> SceneParser::ParsePrefixToken(
...
absl::StatusOr<std::unique_ptr<Node>> SceneParser::ParseInfixToken(
...
absl::StatusOr<std::unique_ptr<Node>> SceneParser::ParseDotAccessor(
    std::unique_ptr<const Token> token, std::unique_ptr<const Node> left) {
...
absl::StatusOr<std::unique_ptr<Node>> SceneParser::ParseAssignment(
    std::unique_ptr<const Token> token, std::unique_ptr<const Node> left) {
  auto node = std::make_unique<Node>(std::move(token));
...
absl::StatusOr<std::unique_ptr<Node>> SceneParser::ParseFunction(
    std::unique_ptr<const Token> token, std::unique_ptr<const Node> left) {
  auto node = std::make_unique<Node>(std::move(token));
